...
# Load the dataset
file_path = r"C:\Users\HP\Downloads\Climate data_jashore_2019-2021 (1).csv"
...
plt.scatter(y_test, y_pred, color='blue', alpha=0.7, edgecolor='k', label='Predicted vs. Actual')
